    ...
    <>
      ...
      <main className="px-5 py-8 sm:px-8 lg:px-10">
        <section
          ...
          className="mx-auto flex min-h-[calc(100vh-8rem)] w-full max-w-6xl scroll-mt-28 flex-col items-center justify-center gap-12 rounded-[2rem] border border-border bg-surface-elevated px-6 py-16 text-center shadow-2xl shadow-black/5 backdrop-blur sm:px-10 lg:grid lg:grid-cols-[1.05fr_0.95fr] lg:px-14 lg:text-left"
        >
          <div className="max-w-2xl">
            ...
            <p className="mt-6 text-pretty text-base leading-8 text-muted sm:text-lg">
              Nền giao diện đã có header, footer, navigation responsive và cấu
              trúc component rõ ràng để tiếp tục xây hero, tính năng, thông số
              và newsletter.
            </p>
